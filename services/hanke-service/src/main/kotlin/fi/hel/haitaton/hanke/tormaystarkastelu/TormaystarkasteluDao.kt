...
interface TormaystarkasteluDao {
     ...
     *
     * @return true for all those geometries that are located on general street area.
     * If returned map is empty then none of the geometries are on a general street area.
     */
    ...
    /**
     * Checks which of these Hanke geometries are located on
     * central business area ("kantakapunki", central_business_area)
     *
     * @return true for all those geometries that are located on central business area.
     * If returned map is empty then none of the geometries are on central business area.
     */
     ...
     *
     * @return for each Hanke geometry a set of TormaystarkasteluBussireitti
     * for the bus routes that geometry is located on
     */
     ...
     *
     * @return for each Hanke geometry a set of TormaystarkasteluRaitiotiekaistatyyppi
     * for the tram lane types that geometry is located on
     */
    fun raitiotiet(hankegeometriat: HankeGeometriat): Map<Int, Set<TormaystarkasteluRaitiotiekaistatyyppi>>

    /**
     * Checks whether these Hanke geometries are on any
     * categorized cycling route ("pyöräilyreitti", cycleways_priority/cycleways_main)
     *
     * @return for each Hanke geometry a set of TormaystarkasteluPyorailyreittiluokka
     * for the cycleways that geometry is located on
     */
