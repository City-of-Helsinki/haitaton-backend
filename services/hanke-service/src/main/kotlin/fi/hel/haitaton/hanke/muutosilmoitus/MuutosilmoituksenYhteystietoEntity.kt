...
@Entity
@Table(name = "muutosilmoituksen_yhteystieto")
class MuutosilmoituksenYhteystietoEntity(
    ...
    @JoinColumn(name = "muutosilmoitus_id", nullable = false)
    ...
    @BatchSize(size = 100)
    override var yhteyshenkilot: MutableList<MuutosilmoituksenYhteyshenkiloEntity> = mutableListOf(),
) : YhteystietoEntity<MuutosilmoituksenYhteyshenkiloEntity>
