...
open class HankeServiceImpl(
        ...
        if (validYhteystieto) {
            ...
            val hankeYhtEntity =
                HankeYhteystietoEntity(
                    ...
                    yhteyshenkilot = hankeYht.yhteyshenkilot,
    ...
    private fun processUpdateYhteystieto(
        ...
        if (validYhteystieto) {
            ...
            if (!areEqualIncomingVsExistingYhteystietos(hankeYht, existingYT)) {
                ...
                existingYT.yhteyshenkilot = hankeYht.yhteyshenkilot
    ...
    private fun areEqualIncomingVsExistingYhteystietos(
        ...
        if (incoming.yhteyshenkilot != existing.yhteyshenkilot) return false
        return true
    }
     ...
     * - Generated flag true.
     * - Hanke name is same as application name.
