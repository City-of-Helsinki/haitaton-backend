...
interface CableReportService {
    ...
    fun update(applicationId: Int, cableReport: CableReportApplication): Int

    fun addAttachment(applicationId: Int, metadata: AttachmentInfo, file: ByteArray)
    fun getAttachments(applicationId: Int): List<AttachmentInfo>
    fun getAttachment(applicationId: Int, attachmentId: Int): ByteArray
