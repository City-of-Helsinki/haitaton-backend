...
@Component
@Profile("!test")
class WmsMapGenerator(private val wms: WebMapServer) : MapGenerator {
    ...
    companion object {
        ...
        private fun readPolygon(polygon: Polygon): SimpleFeatureCollection =
            readPolygons(listOf(polygon))

        private fun readPolygons(polygons: List<Polygon>): SimpleFeatureCollection {
            ...
            polygons.forEach { polygon ->
                ...
                val geometry = reader.read(copy.toJsonString()) as org.locationtech.jts.geom.Polygon
