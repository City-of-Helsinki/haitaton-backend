...
enum class RaitiotieTormaysLuokittelu(override val value: Int, override val explanation: String) : Luokittelu {
    RAITIOTIELINJA(5, "Raitiotieverkon rataosa, jolla on säännöllistä linjaliikennettä"),
    RAITIOTIEVERKON_RATAOSA(3, "Raitiotieverkon rataosa, joilla ei ole säännöllistä linjaliikennettä"),
