...
internal class DisclosureLogServiceTest {
    ...
    @Nested
    inner class SaveDisclosureLogsForProfiili {
        @Test
    ...
    @Nested
    inner class SaveDisclosureLogsForHanke {
        @Test
        ...
        fun `saveDisclosureLogsForHanke saves identical audit logs only once`() {
            ...
            val expectedLogs =
                listOf(
                    AuditLogEntryFactory.createReadEntry(objectBefore = yhteystieto.toJsonString())
                )
    ...
    @Nested
    inner class SaveDisclosureLogsForHankkeet {
        @Test
        ...
        fun `saveDisclosureLogsForHankkeet saves audit logs for all yhteystiedot in all hankkeet`() {
            ...
            val expectedLogs =
                hankkeet.flatMap { AuditLogEntryFactory.createReadEntriesForHanke(it) }
    ...
    @Nested
    inner class SaveDisclosureLogsForHankeKayttaja {
        @Test
    ...
    @Nested
    inner class SaveDisclosureLogsForHankeKayttajat {
        @Test
    ...
    @Nested
    inner class SaveDisclosureLogsForApplication {
        @Test
    ...
    inner class SaveDisclosureLogsForHakemusResponse {
        @Test
        fun `saveDisclosureLogsForHakemusResponse with company customers and no contacts does nothing`() {
            val customerWithoutContacts =
        ...
        @Test
        fun `saveDisclosureLogsForHakemusResponse doesn't save entries for blank contacts`() {
            val customerWithoutContacts =
                HakemusFactory.createCompanyCustomer(name = "First").withContacts()
            val contractorWithoutContacts =
        ...
        @Test
        fun `saveDisclosureLogsForHakemusResponse doesn't save entries for blank customers`() {
            val blankCustomer =
        ...
        @Test
        fun `saveDisclosureLogsForHakemusResponse with identical person customers logs every instance`() {
            val customerWithoutContacts =
        ...
        fun `saveDisclosureLogsForApplications logs customers and contacts from all applications while ignoring duplicates`() {
            ...
            assertThat(capturedLogs.captured)
                .containsExactlyInAnyOrder(
                    ...
                    // The first contact is added twice for the first customer, but identical
                    // entries
