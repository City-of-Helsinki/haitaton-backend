...
internal class TormaystarkasteluPaikkaServiceImplTest {
    ...
    fun calculateTormaystarkasteluLuokitteluTulos_whenNoHitsWithGeometry() {
        ...
        assertThat(result.get(1)).isEqualTo(Luokittelutulos(hanke.geometriat!!.id!!, LuokitteluType.LIIKENNEMAARA, 0, "Ei autoliikennettä"))
    ...
    fun calculateTormaystarkasteluLuokitteluTulos_whenExpected3FromKatuluokka() {
        ...
        Mockito.`when`(tormaysPaikkaDao.liikennemaarat(hanke.geometriat!!,TormaystarkasteluLiikennemaaranEtaisyys.RADIUS_15))
        ...
        assertThat(result[1]).isEqualTo(Luokittelutulos(hanke.geometriat!!.id!!, LuokitteluType.LIIKENNEMAARA, 0,  "Ei autoliikennettä"))
    ...
    fun calculateTormaystarkasteluLuokitteluTulos_whenExpected4FromYleisetKatuluokatAndAlsoHitInKatualue() {
        ...
        Mockito.`when`(tormaysPaikkaDao.katuluokat(hanke.geometriat!!)).thenReturn(mutableMapOf())
        // Liikennemaara maximum=0
        Mockito.`when`(tormaysPaikkaDao.liikennemaarat(hanke.geometriat!!,TormaystarkasteluLiikennemaaranEtaisyys.RADIUS_30))
                .thenReturn(mutableMapOf(Pair(hanke.geometriat!!.id!!, setOf(0))))
    ...
    fun calculateTormaystarkasteluLuokitteluTulos_WhenKatuluokka1_AndLiikenneMaara1000() {
        ...
        //hit in katuluokat
        var katuluokat = mutableMapOf(Pair(hanke.geometriat!!.id!!, setOf(TormaystarkasteluKatuluokka.TONTTIKATU_TAI_AJOYHTEYS)))
    ...
    fun calculateTormaystarkasteluLuokitteluTulos_WhenKatuluokka4_AndLiikenneMaara3500() {
        ...
        //hit in katuluokat
        var katuluokat = mutableMapOf(Pair(hanke.geometriat!!.id!!, setOf(TormaystarkasteluKatuluokka.PAAKATU_TAI_MOOTTORIVAYLA)))
        Mockito.`when`(tormaysPaikkaDao.katuluokat(hanke.geometriat!!)).thenReturn(katuluokat)
