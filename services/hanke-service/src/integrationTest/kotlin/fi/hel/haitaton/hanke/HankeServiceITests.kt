...
class HankeServiceITests : DatabaseTest() {
    ...
    fun `test adding identical Yhteystietos in different groups and removing the other`() {
        ...
        returnedHanke.rakennuttajat[0].organisaatioId = 0 // does not really matter, but...
    ...
    private fun verifyAlikontakti(alikontaktit: List<Alikontakti>) {
        assertThat(alikontaktit).isNotEmpty
        alikontaktit.forEach {
