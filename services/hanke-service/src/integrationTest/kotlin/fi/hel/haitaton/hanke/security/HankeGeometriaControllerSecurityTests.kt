 ...
 * HankeGeometriatControllerITests. As long as the mocked operation goes through and returns
...
class HankeGeometriaControllerSecurityTests(@Autowired val mockMvc: MockMvc) {
    ...
    private fun performGetHankkeetTunnusGeometriat(): ResultActions {
        ...
        every { hankeGeometriatService.loadGeometriat(any()) } returns hankeGeometriat
