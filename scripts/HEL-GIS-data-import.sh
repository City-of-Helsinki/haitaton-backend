...
echo Importing tormays_tram_infra_polys.gpkg...
docker run --rm --network=haitaton-backend_backbone osgeo/gdal:alpine-small-latest ogr2ogr -overwrite -f PostgreSQL PG:"dbname='haitaton' host='db' port='5432' user='haitaton_user' password='haitaton'" http://haitaton-fileshare-dev.internal.apps.arodevtest.hel.fi/tormays_tram_infra_polys.gpkg
echo tormays_tram_infra_polys.gpkg imported OK.
echo Importing tormays_tram_lines_polys.gpkg...
docker run --rm --network=haitaton-backend_backbone osgeo/gdal:alpine-small-latest ogr2ogr -overwrite -f PostgreSQL PG:"dbname='haitaton' host='db' port='5432' user='haitaton_user' password='haitaton'" http://haitaton-fileshare-dev.internal.apps.arodevtest.hel.fi/tormays_tram_lines_polys.gpkg
echo tormays_tram_lines_polys.gpkg imported OK.
